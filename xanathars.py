...
def barbarian_xgte():
    barbarian_totems = [
        ...
        "Three eagle feathers given to you by a wise shaman, who told you they would play a role in determining your "
        "fate.",
        ...
        "A few small bones from the first beast you killed, tied together with coloured wool.",
    ...
    barbarian_tattoos = [
        ...
        "Etched on the backs of your hands are the claws of a cave bear.",
        "The symbols of you clan are displayed in viny patterns along your arms.",
    ...
    barbarian_superstitions = [
        "If you disturb the bones of the dead, you inherit all the troubles that plagued them in life.",
        "Never trust a wizard. They're all devils in disguise, especially friendly ones.",
        ...
        "If an elf looks you in the eyes, she is trying to read your thoughts."
    ]
    ...
    barbarian_background = [
        ...
        "I lost control in battle one day, and it was as if something else was manipulating my body, forcing it to "
        "kill every foe I could reach.",
        "I went on a spiritual journey to find myself and instead found a spirit animal to guide, protect, and "
        "inspire me.",
        "I was struck by lightning and lived. Afterward, I found a new strength within me that let me push beyond my "
        "limitations.",
        "My anger needed to be channeled into battle, or I risked becoming an indiscriminate killer.",
    ]

    totem = random.choice(barbarian_totems)
    tattoo = random.choice(barbarian_tattoos)
    superstition = random.choice(barbarian_superstitions)
    background = random.choice(barbarian_background)

    return totem, tattoo, superstition, background


def bard_xgte():
    bard_defining_work = [
        "'The Three Flambinis', a ribald song concerning mistaken identities and an unfettered desire.",
        "'Waltz of the Myconids', an upbeat tune that children particularly enjoy.",
        ...
        "'A Hoop, Two Pidgeons and a Hell Hound', a subtle parody of an incompetent noble.",
    ...
    bard_embarrassment = [
        "The time when your comedic song, 'Big Tom's Hijinks' - which by the way, you thought was brilliant - did not "
        "go over well with Big Tom.",
        ...
        "The first and last performance of 'Mirt, Man about Town'.",
    ...
    defining_work = random.choice(bard_defining_work)
    instrument = random.choice(bard_instrument)
    embarrassment = random.choice(bard_embarrassment)
    background = random.choice(bard_background)

    return defining_work, instrument, embarrassment, background
...
def cleric_xgte():
    ...
    cleric_keepsake = [
        ...
        "A runes tone said to be blessed by your god."
    ]
    ...
    cleric_secret = [
        ...
        "Even though you can work divine magic, you have never truly felt the presence of a divine essence within "
        "yourself.",
        "You are plagued by nightmares that you believe are sent by your god as punishment for some unknown "
        "transgression.",
    ...
    cleric_background = [
        ...
        "I used to serve in my religion's bureaucracy but found I needed to work in the world, to bring the message "
        "of my faith to the darkest corners of the land.",
        "I realize that my god works through me, and I do as commanded, even though I don't know why I was chosen "
        "to serve."
    ]

    temple = random.choice(cleric_temple)
    keepsake = random.choice(cleric_keepsake)
    secret = random.choice(cleric_secret)
    background = random.choice(cleric_background)

    return temple, keepsake, secret, background


def druid_xgte():
    druid_treasured_items = [
    ...
    druid_guiding_aspects = [
        "Yew trees remind you of renewing your mind and spirit, letting the old die and the new spring forth.",
        "Oak trees represent strength and vitality. Meditating under an oak fills your body and mind with resolve and "
        "fortitude.",
        "The river's endless flow reminds you of the great span of the world. You seek to act with the long-term "
        "interests of nature in mind.",
        "The sea is a constant, churning cauldron of power and chaos. It reminds you that accepting change is "
        ...
        "As demonstrated by the actions of the wolf, an individual's strength is nothing compared to the power of the "
        "pack."
    ]

    druid_mentor = [
        "Your mentor was a wise treant who taught you to think in terms of years and decades rather than days or "
        "months.",
        "You were tutored by a dryad who watched over a slumbering portal to the Abyss. During your training, you were "
        "tasked with watching for hidden threats to the world.",
        "Your tutor always interacted with you in the form of a falcon. You never saw the tutor's humanoid form.",
        "You were one of several youngsters who were mentored by an old druid, until one of your fellow pupils "
        "betrayed your group and killed your master.",
        "Your mentor has appeared to you only in visions. You have yet to meet this person, and you are not sure such "
        "a person exists in mortal form.",
        "Your mentor was a werebear who taught you to treat all living things with equal regard ."
    ]

    druid_background = [
        "I saw too much devastation in the wild places, too much of nature's splendor ruined by the despoilers. I "
        "joined a circle of druids to fight back against the enemies of nature.",
        "I found a place among a group of druids after I fled a catastrophe.",
        "I have always had an affinity for animals, so I explored my talent to see how I cou ld best use it.",
        "I befriended a druid and was moved by druidic teachings. I decided to follow my friend's guidance and give "
        "something back to the world.",
        "While I was growing up, I saw spirits all around me - entities no one else could perceive. I sought out the "
        "druids to help me understand the visions and communicate with these beings.",
        "I have always felt disgust for creatures of unnatural origin. For this reason, I immersed myself in the study "
        "of the druidic mysteries and became a champion of the natural order.",
    ]

    treasured_item = random.choice(druid_treasured_items)
    guiding_aspect = random.choice(druid_guiding_aspects)
    mentor = random.choice(druid_mentor)
    background = random.choice(druid_background)

    return treasured_item, guiding_aspect, mentor, background


def fighter_xgte():
    fighter_heraldic_signs = [
        ...
        "Three drops of blood beneath a horizontal sword blade on a black background, symbolizing three foes you have "
        "sworn to kill."
    ]

    fighter_instructors = [
        "Gladiator. Your instructor was a slave who fought for freedom in the arena, or one who willingly chose the "
        "gladiator's life to earn money and fame.",
        ...
        "Tribal Warrior. Your instructor grew up in a tribe, where fighting for one's life was practically an everyday "
        "occurrence.",
        "Street Fighter. Your trainer excels at urban combat, combining close-quarters work with silence and "
        "efficiency.",
        "Weapon Master. Your mentor helped you to become one with your chosen weapon, by imparting highly specialized "
        "knowledge of how to wield it most effectively."
    ]

    fighter_signature_style = [
        ...
        "Cunning. You dart in to attack at just the right moment and use small-scale tactics to tilt the odds in your "
        "favor.",
        "Effortless. You rarely perspire or display anything other than a stoic expression in battle.",
        "Energetic. You sing and laugh during combat as your spirit soars. You are happiest when you have a foe in "
        "front of you and a weapon in hand.",
    ...
    fighter_background = [
        ...
        "I squired for a knight who taught me how to fight, care for a steed , and conduct myself with honor. I"
        ...
        "creatures and others of a similar nature.",
    ...
    heraldic_sign = random.choice(fighter_heraldic_signs)
    instructor = random.choice(fighter_instructors)
    signature_style = random.choice(fighter_signature_style)
    background = random.choice(fighter_background)

    return heraldic_sign, instructor, signature_style, background


def monk_xgte():
    monk_monastery = [
        "Your monastery is carved out of a mountain side, where it looms over a treacherous pass.",
        "Your monastery is high in the branches of an immense tree in the Feywild.",
        "Your monastery was founded long ago by a cloud giant and is inside a cloud castle that can be reached only by "
        "flying.",
        "Your monastery is built beside a volcanic system of hot springs, geysers, and sulfur pools. You regularly "
    ...
    monk_monastic_icons = [
        "Monkey. Quick reflexes and the ability to travel through the treetops are two of the reasons why your order "
        "admires the monkey.",
        "Dragon Turtle. The monks of your seaside monastery venerate the dragon turtle, reciting ancient prayers and "
        "offering garlands of flowers to honor this living spirit of the sea.",
        "Ki-rin. Your monastery sees its main purpose as watching over and protect ing the land in the manner of the "
        "ki-rin.",
        "Owlbear. The monks of your monastery revere a family of owl bears and have coexisted with them for "
        "generations.",
    ...
    monk_master = [
        ...
        "Your master was merciless in pushing you to your limits. You nearly Jost an eye during one especially brutal "
        "practice session.",
        ...
        "Your master was kind and generous, never critical of your progress. Nevertheless, you feel you never fully "
        "lived up to the expectations placed on you."
    ]

    monk_background = [
        "I was chosen to study at a secluded monastery. There, I was taught the fundamental techniques required to "
        "eventually master a tradition.",
        "I sought instruction to gain a deeper understanding of existence and my place in the world.",
        "I stumbled into a portal to the Shadowfell and took refuge in a strange monastery, where I learned how to "
        "defend myself against the forces of darkness.",
        "I was overwhelmed with grief after losing someone close to me, and I sought the advice of philosophers to "
        "help me cope with my loss.",
        "I could feel that a special sort of power lay within me, so I sought out those who could help me call it "
        "forth and master it.",
        "I was wild and undisciplined as a youngster, but then I realized the error of my ways. I applied to a "
        "monastery and became a monk as a way to live a life of discipline.",
    ]

    monastery = random.choice(monk_monastery)
    monastic_icon = random.choice(monk_monastic_icons)
    master = random.choice(monk_master)
    background = random.choice(monk_background)

    return monastery, monastic_icon, master, background


def paladin_xgte():
    paladin_personal_goals = [
        ...
        "Leadership. You will win a great battle that bards will sing about, and in so doing, you will become an "
    ...
    paladin_nemesis = [
        ...
        "A fiend or a celestial, the agent of a power of the Outer Planes, who has been charged with corrupting or "
        "redeeming you, as appropriate.",
    ...
    paladin_temptation = [
        "Fury. When your anger is roused, you have trouble thinking straight, and you fear you might do something "
        "you'll regret.",
        ...
        "Envy. You are mindful of what some famous folk have accomplished, and you feel inadequate when your deeds "
        "don't compare to theirs.",
        "Despair. You consider the great strength of the enemies you must defeat, and at times you see no way to "
    ...
    paladin_background = [
        ...
        "The world is a dark and terrible place. I decided to serve as a beacon oflight shining out against the "
        "gathering shadows.",
        "I served as a paladin's squire, learn ing all I needed to swear my own sacred oath.",
        "Evil must be opposed on all fronts. I feel compelled to seek out wickedness and purge it from the world.",
        "Becoming a paladin was a natural consequence of my unwave ring faith. In taking my vows, I became the holy "
        "sword of my religion."
    ]

    personal_goal = random.choice(paladin_personal_goals)
    symbol = random.choice(paladin_symbols)
    nemesis = random.choice(paladin_nemesis)
    temptation = random.choice(paladin_temptation)
    background = random.choice(paladin_background)

    return personal_goal, symbol, nemesis, temptation, background


def ranger_xgte():
    ranger_views_of_the_world = [
        ...
        "Towns and cities are a necessary evil, but once the wilderness is purged of supernatural threats, we will "
        "need them no more.",
    ...
    ranger_homeland = [
        ...
        "Because yo u grew up among the peaks, finding the best path through the mountains is second nature to you.",
    ...
    ranger_background = [
        "I found purpose while I honed my hunting skills by bringing down dangerous animals at the edge of "
        "civilization.",
        "I a lways had a way with animals, able to calm them with a soothing word and a touch.",
        "I suffer from terrible wanderlust, so being a ranger gave me a reason not to remain in one place for too "
        "long.",
        "I have seen what happens when the monsters come out from the dark. I took it upon myself to become the "
        "first line of defense against the evils that lie beyond civilization's borders.",
        "I met a grizzled ranger who taught me woodcraft and the secrets of the wild lands.",
        "I served in an army, learning the precepts of my professio n while blazing trails and scouting enemy "
        "encampments."
    ]

    view_of_the_world = random.choice(ranger_views_of_the_world)
    homeland = random.choice(ranger_homeland)
    sworn_enemy = random.choice(ranger_sworn_enemy)
    background = random.choice(ranger_background)

    return view_of_the_world, homeland, sworn_enemy, background


def rogue_xgte():
    rogue_guilty_pleasure = [
        "Large gems.",
    ...
    rogue_benefactors = [
        "A smuggler kept you from getting caught but lost a valuable shipment in doing so. Now you owe that person an "
        "equally valuable favor.",
        ...
        "A dragon didn't eat you when it had a chance, and in return you promised to set aside choice pieces of "
        "treasure for it.",
        "A druid once helped you out of a tight spot; now any random animal you see could be that benefactor, perhaps "
        "come to claim a return favor."
    ]

    rogue_background = [
        "I've always been nimble and quick of wit, so I decided to use those talents to help me make my way in the"
        "world.",
        "An assassin or a thief wronged me, so I focused my training on mastering the skills of my enemy to better "
        "combat foes of that sort.",
        "An experienced rogue saw something in me and taught me several useful tricks.",
        "I decided to turn my natural lucky streak into the basis of a career, though I still realize that improving "
        "my skills is essential.",
        "I took up with a group of ruffians who showed me how to get what I want through sneakiness rather than "
        "direct confrontation.",
        "I'm a sucker fo r a shiny bauble or a sack of coins, as long as I can get my hands on it without risking "
        "life and limb."
    ]

    guilty_pleasure = random.choice(rogue_guilty_pleasure)
    adversary = random.choice(rogue_adversaries)
    benefactor = random.choice(rogue_benefactors)
    background = random.choice(rogue_background)

    return guilty_pleasure, adversary, benefactor, background


def sorcerer_xgte():
    sorcerer_arcane_origins = [
        "Your power arises from your family's bloodline.",
        "You are related to some powerful creature, or you inherited a blessing or a curse.",
    ...
    sorcerer_reactions = [
        "Your powers are seen as a great blessing by those around you, and you are expected to use them in service to "
        "your community.",
        ...
        "Your powers are believed to be tied to an ancient line of mad kings that supposedly ended in a bloody revolt "
        "over a century ago."
    ]

    sorcerer_supernatural_marks = [
    ...
    sorcerer_background = [
        "When I was born, all the water in the house froze solid, the milk spoiled, or all the iron turned to copper. "
        "My family is convinced that this event was a harbinger of stranger things to come for me.",
        "I suffered a terrible emotional or physical strain, which brought forth my latent magical power. I have "
        "fought to control it ever since.",
        "My immediate family never s poke of my ancestors, and when I asked, they would change the subject.",
        "It wasn't until I started displaying strange talents that the full truth of my heritage came out.",
        "When a monster threatened one of my friends, I became filled with anxiety. I lashed out instinctively and "
        "blasted the wretched thing with a force that came from within me.",
        "Sensing something special in me, a stranger taught me how to control my gift.",
        "After I escaped from a magical conAagration, I realized that though I was unharmed, I was not unchanged. I "
        "began to exhibit unusual abilities that I am just beginning to understand."
    ]

    arcane_origin = random.choice(sorcerer_arcane_origins)
    reactions = random.choice(sorcerer_reactions)
    supernatural_mark = random.choice(sorcerer_supernatural_marks)
    signs_of_sorcery = random.choice(sorcerer_signs_of_sorcery)
    background = random.choice(sorcerer_background)

    return arcane_origin, reactions, supernatural_mark, signs_of_sorcery, background


def warlock_xgte():
    warlock_patron_attitudes = [
        ...
        "Your patron is the spirit of a long-dead hero who sees your pact as a way for it to continue to influence "
        "the world.",
        ...
        "You are mostly left to your own devices with no interference from your patron. Sometimes you dread the "
        "demands it will make when it does appear."
    ]

    warlock_special_terms = [
    ...
    warlock_background = [
        "While wandering around in a forbidden place, I encountered an otherworldly being that offered to enter into "
        "a pact with me.",
        "I was examining a strange tome I found in an abandoned library when the entity that would become my patron "
        ...
        "When I was faced with a terrible crisis, I prayed to any being who would listen, and the creature that "
        "answered became my patron.",
        "My future patron visited me in my dreams and offered great power in exchange for my service.",
        "One of my ancestors had a pact with my patron, so that entity was determined to bind me to the same "
        "agreement."
    ]

    patron_attitudes = random.choice(warlock_patron_attitudes)
    special_terms = random.choice(warlock_special_terms)
    binding_mark = random.choice(warlock_binding_mark)
    background = random.choice(warlock_background)

    return patron_attitudes, special_terms, binding_mark, background
...
def wizard_xgte():
    ...
    wizard_eccentricities = [
        ...
        "Your fashion sense and grooming, o r more accurately lack thereof, sometimes cause others to assume you are "
        "a beggar."
    ]
    ...
    wizard_background = [
        ...
        "I grew up listening to tales of great wizards and knew I wanted to follow their path. I strove to be "
        ...
        "While exploring an old tomb, library, or temple, I found a spellbook. I was immediately driven to learn all "
        "I could about becoming a wizard.",
        "I was a prodigy who demonstrated mastery of the arcane arts at an early age. When I became old enough to set "
        "out on my own, I did so to learn more magic and expand my power."
    ]

    spellbook = random.choice(wizard_spellbooks)
    ambition = random.choice(wizard_ambitions)
    eccentricity = random.choice(wizard_eccentricities)
    background = random.choice(wizard_background)

    return spellbook, ambition, eccentricity, background
